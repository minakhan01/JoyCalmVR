...
[AddComponentMenu("GoogleVR/MotionViewer")]
public class MotionViewer : MonoBehaviour {
  ...
  public static MotionViewer Instance {
    get {
#if UNITY_EDITOR
      if (instance == null && !Application.isPlaying) {
        instance = UnityEngine.Object.FindObjectOfType<MotionViewer>();
      }
#endif
      if (instance == null) {
  ...
  private static MotionViewer instance = null;

  /// Generate a GvrViewer instance.  Takes no action if one already exists.
  public static void Create() {
    if (instance == null && UnityEngine.Object.FindObjectOfType<MotionViewer>() == null) {
      Debug.Log("Creating GvrViewer object");
      var go = new GameObject("MotionViewer", typeof(MotionViewer));
